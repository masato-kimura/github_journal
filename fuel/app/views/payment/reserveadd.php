...
jQuery(function() {
	...
	$('.form_every_type').on('change', function() {
		...
		$('.every_selected_row .form-error').css('border', '0px').empty();
		switch($(this).val())
		{
			case "3": // year
...
<div class="container">
	...
	<h5 class="header"><i class="material-icons prefix" style="color: #ccc;">mode_edit</i>定期支出データ登録</h5>

	<div class="row">
		<?php echo Form::open(array('action' => '/payment/reserveadddone/', 'class' => 'col s12'));?>
			<div class="row">
				<div class="input-field col s12">
					<?php echo Form::label('定期間隔<span class="form-required">* 必須</span>', '', array('style' => 'font-size: smaller;'));?>
					<div class="row" style="margin-top: 10px;">
						<div class="input-field col s12 l2">
							<?php echo Form::radio('every_type', '3', \Input::param('every_type'), array('id' => 'form_every_type_year', 'class' => 'with-gap form_every_type'));?>
							<?php echo Form::label('年毎', 'every_type_year');?>
						</div>
						<div class="input-field col s12 l2">
							<?php echo Form::radio('every_type', '2', \Input::param('every_type', '2'), array('id' => 'form_every_type_month', 'class' => 'with-gap form_every_type'));?>
							<?php echo Form::label('月毎', 'every_type_month');?>
						</div>
						<div class="input-field col s12 l2">
							<?php echo Form::radio('every_type', '1', \Input::param('every_type'), array('id' => 'form_every_type_week', 'class' => 'with-gap form_every_type'));?>
							<?php echo Form::label('週毎', 'every_type_week');?>
						</div>
						<div class="input-field col s12 l2">
							<?php echo Form::radio('every_type', '0', \Input::param('every_type'), array('id' => 'form_every_type_day', 'class' => 'with-gap form_every_type'));?>
			...
			<div class="row every_selected_row">
				<div class="col s4">
					<?php if (isset($arr_validation_error['every_month_selected'])):?>
						...
						<?php echo Form::select('every_month_selected', \Input::post('every_month_selected'), $arr_month_list, array('class' => 'every_selected every_month_selected'));?>
				...
				<div class="col s4">
					<?php if (isset($arr_validation_error['every_day_selected'])):?>
						...
						<?php echo Form::select('every_day_selected', \Input::post('every_day_selected'), $arr_day_list, array('class' => 'every_selected every_day_selected'));?>
				...
				<div class="col s4">
					<?php if (isset($arr_validation_error['every_dayofweek_selected'])):?>
						...
						<?php echo Form::select('every_dayofweek_selected', \Input::post('every_dayofweek_selected'), $arr_dayofweek_list, array('class' => 'every_selected every_dayofweek_selected'));?>
			...
			<div class="row">
				<div class="input-field col s6">
					<?php if (isset($arr_validation_error['date_from'])):?>
						<?php echo Form::input('date_from', \Input::param('date_from', \Date::forge(\Date::forge()->get_timestamp())->format('%Y-01-01')), array('class' => 'datepicker invalid', 'placeholder' => '')); ?>
						<?php echo Form::label('有効期間開始日<span class="form-required">* 必須</span>', 'date_from');?>
						<div class="form-error"><?php echo $arr_validation_error['date_from'];?></div>
					<?php else:?>
						<?php echo Form::input('date_from', \Input::param('date_from', \Date::forge(\Date::forge()->get_timestamp())->format('%Y-01-01')), array('class' => 'datepicker', 'placeholder' => '')); ?>
						<?php echo Form::label('有効期間開始日<span class="form-required">* 必須</span>', 'date_from');?>
					<?php endif;?>
				</div>
				...
				<div class="input-field col s6">
					<?php if (isset($arr_validation_error['date_to'])):?>
						<?php echo Form::input('date_to', \Input::param('date_to', \Date::forge(\Date::forge()->get_timestamp())->format('%Y-12-31')), array('class' => 'datepicker invalid', 'placeholder' => '')); ?>
						<?php echo Form::label('期間終了日時<span class="form-required">* 必須</span>', 'date_to');?>
						<div class="form-error"><?php echo $arr_validation_error['date_to'];?></div>
					<?php else:?>
						<?php echo Form::input('date_to', \Input::param('date_to', \Date::forge(\Date::forge()->get_timestamp())->format('%Y-12-31')), array('class' => 'datepicker', 'placeholder' => '')); ?>
						<?php echo Form::label('期間終了日時<span class="form-required">* 必須</span>', 'date_to');?>
					<?php endif;?>
				</div>
			</div>
			...
			<div class="row">
				<div class="col s12">
					<?php if (isset($arr_validation_error['fix_id'])):?>
						<?php echo Form::label('登録済みのカテゴリー<span class="form-required">* 必須</span><br />
						（カテゴリーリストの登録・編集は'. Html::anchor('/fix/', 'こちら').'）', 'fix_id', array('style' => 'margin-bottom: 12px; display: inline-block;'));?>
			...
			<div class="row">
				<div class="input-field col s12">
					<?php if (isset($arr_validation_error['cost'])):?>
						...
						<?php echo Form::label('支払い金額<span class="form-required">* 必須</span><br />
						（未定の場合は０円もしくはおおよその金額を入力します。）', 'cost', array('class' => 'cost'));?>
			...
			<div class="row">
				<div class="input-field col s12">
					<?php echo Form::label('仕事比率', '', array('style' => 'font-size: smaller; margin-bottom: 10px;'));?>
					<div class="row" style="margin-top: 10px;">
						<div class="input-field col s12 l2">
			...
			<div class="row">
				<div class="input-field col s12">
					<?php echo Form::button('to_submit', '<i class="material-icons right">send</i>登録する', array('type' => 'submit', 'class' => 'btn btn-submit waves-effect waves-light pink darken-3'));?>
				</div>
			</div>
		<?php echo Form::close();?>
	</div>
