...
requireservice 'general/GeneralTests.php';
requireservice 'tasks/AllTasksTests.php';
requireservice 'pagespeed/AllPageSpeedTests.php';
requireservice 'urlshortener/AllUrlShortenerTests.php';
requireservice 'plus/PlusTest.php';
