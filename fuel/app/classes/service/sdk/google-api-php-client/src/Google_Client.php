...
requireservice 'service/Google_Model.php';
requireservice 'service/Google_Service.php';
requireservice 'service/Google_ServiceResource.php';
requireservice 'auth/Google_AssertionCredentials.php';
requireservice 'auth/Google_Signer.php';
requireservice 'auth/Google_P12Signer.php';
requireservice 'service/Google_BatchRequest.php';
requireservice 'external/URITemplateParser.php';
requireservice 'auth/Google_Auth.php';
requireservice 'cache/Google_Cache.php';
requireservice 'io/Google_IO.php';
requireservice('service/Google_MediaFileUpload.php');
